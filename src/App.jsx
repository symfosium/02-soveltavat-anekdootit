...
function App() {
  ...
  const [votes, setVotes] = useState(new Array(anecdotes.length).fill(0)); // Массив голосов для каждого анекдота
  ...
  const mostVotedAnecdote = () => {
    ...
    let mostVotedIndex = votes.indexOf(maxVotes);
    ...
    <div>
     <div>{anecdotes[selected]}</div>
      ...
      <>
        ...
        <p>With {mostVoted.votes} votes</p>
      </>
    )}
    </div>
  )
